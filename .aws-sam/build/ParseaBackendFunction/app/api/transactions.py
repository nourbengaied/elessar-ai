...
@router.put("/{transaction_id}/details")
async def update_transaction_details(
    ...
    """
    Update transaction details (description, amount, date, category)
    """
    try:
        ...
        transaction.date = datetime.strptime(request.date, "%Y-%m-%d").date()
