...
const Dashboard: React.FC = () => {
    ...
    return (
        <div className="animate-fade-in">
            {/* Header */}
            <div className="bg-white/60 backdrop-blur-sm py-8 px-8 animate-slide-down">
                <h1 className="text-2xl font-bold text-gray-900 tracking-tight">Parsea</h1>
            ...
            <div className="relative">
                ...
                <div className="relative flex justify-center text-xs uppercase">
                    <span className="bg-white/60 backdrop-blur-sm px-3 text-gray-400 tracking-wider">···</span>
                </div>
            </div>

            {/* Upload Section */}
            <div className="bg-gray-50/80 backdrop-blur-sm py-12 px-8 animate-slide-up">
                <div className="max-w-7xl mx-auto">
                    <div className="flex items-center mb-8">
                        <div className="w-12 h-px bg-gradient-to-r from-brand-500 to-transparent mr-4"></div>
                        <h2 className="text-xl font-semibold text-gray-800 tracking-tight">Get Started</h2>
                    </div>
            ...
            <div className="relative">
                ...
                <div className="relative flex justify-center text-xs uppercase">
                    <span className="bg-gray-50/80 backdrop-blur-sm px-3 text-gray-400 tracking-wider">○ ○ ○</span>
                </div>
            </div>

            {/* Statistics Section */}
            <div className="bg-white/60 backdrop-blur-sm py-12 px-8 animate-slide-up-delay">
                <div className="max-w-7xl mx-auto">
                    <div className="flex items-center mb-8">
                        <div className="w-12 h-px bg-gradient-to-r from-mint-500 to-transparent mr-4"></div>
                        <h2 className="text-xl font-semibold text-gray-800 tracking-tight">Overview</h2>
                    </div>
                            ...
                            <div className="p-6">
                                <div className="flex items-center">
                                    ...
                                    <div className="ml-4 w-0 flex-1">
                                        <dl>
                                            <dt className="text-sm font-medium text-zinc-500 truncate tracking-tight">
                                                Total Transactions
                                            </dt>
            ...
            <div className="bg-slate-50/80 backdrop-blur-sm py-12 px-8 animate-slide-up-delay-2">
                <div className="max-w-7xl mx-auto">
                    <div className="flex items-center mb-8">
                        <div className="w-12 h-px bg-gradient-to-r from-coral-500 to-transparent mr-4"></div>
                        <h2 className="text-xl font-semibold text-gray-800 tracking-tight">How It Works</h2>
                    </div>
                    <div className="transition-all duration-500 animate-slide-up-delay-2">
                        <h3 className="text-xl font-semibold text-gray-900 mb-8 tracking-tight">Process Overview</h3>
                        ...
                        <div className="bg-gradient-to-r from-sand-50 to-sand-100 rounded-xl border border-sand-200 p-8">
                            ...
                            <div className="bg-white/90 backdrop-blur-sm rounded-xl border border-sand-200 overflow-hidden mb-6 shadow-lg">
                                <div className="grid grid-cols-12 bg-sand-50/80 border-b border-sand-200 px-6 py-4">
                                    ...
                                    <div className="col-span-2">
                                        <span className="text-xs font-semibold text-gray-600 uppercase tracking-wide">Confidence</span>
                                    </div>
                                    <div className="col-span-1">
                                ...
                                {sampleTransactions.map((transaction, index) => {
                                    ...
                                    return (
                                        ...
                                        >
                                            ...
                                            <div className="col-span-1 flex items-center">
                                                {isClassified ? (
                                                    <button className="text-xs text-brand-600 hover:text-brand-800 transition-colors duration-200 underline-offset-2 hover:underline">
                                                        Edit
                                                    </button>
                                                ) : (
                                                    <span className="text-sm text-gray-400">—</span>
            ...
            <div className="relative">
                ...
                <div className="relative flex justify-center text-xs uppercase">
                    <span className="bg-slate-50/80 backdrop-blur-sm px-3 text-gray-400 tracking-wider">◆ ◆ ◆</span>
                </div>
            </div>

            {/* Analytics Section */}
            <div className="bg-white/60 backdrop-blur-sm py-12 px-8 animate-slide-up-delay-3">
                <div className="max-w-7xl mx-auto">
                    <div className="flex items-center mb-8">
                        <div className="w-12 h-px bg-gradient-to-r from-brand-600 to-transparent mr-4"></div>
                        <h2 className="text-xl font-semibold text-gray-800 tracking-tight">Analytics</h2>
                    </div>
                    <div className="grid grid-cols-1 lg:grid-cols-1 gap-6 animate-slide-up-delay-3">
                        {/* Pie Chart - Smaller */}
                                    ...
                                    <PieChart>
                                        ...
                                        >
                                            {pieData.map((entry, index) => (
                                                <Cell key={`cell-${index}`} fill={index === 0 ? '#4A7C59' : '#F8C7B4'} />
                                            ))}
                                        </Pie>
                                        <Tooltip />
                                    </PieChart>
            ...
            <div className="bg-gray-50/80 backdrop-blur-sm py-12 px-8 animate-slide-up-delay-3">
                <div className="max-w-7xl mx-auto">
                    <div className="flex items-center mb-8">
                        <div className="w-12 h-px bg-gradient-to-r from-mint-600 to-transparent mr-4"></div>
                        <h2 className="text-xl font-semibold text-gray-800 tracking-tight">Quick Actions</h2>
                    </div>
                    <div className="transition-all duration-500 animate-slide-up-delay-3">
                        <h3 className="text-xl font-semibold text-gray-900 mb-6 tracking-tight">Get Things Done</h3>
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                            ...
                            >
                                ...
                                <div className="flex-1 min-w-0">
                                    ...
                                    <p className="text-base font-medium text-gray-900 tracking-tight group-hover:text-brand-700 transition-colors duration-300">View Transactions</p>
                            ...
                            >
                                ...
                                <div className="flex-1 min-w-0">
                                    <span className="absolute inset-0" aria-hidden="true" />
                                    <p className="text-base font-medium text-gray-900 tracking-tight group-hover:text-brand-700 transition-colors duration-300">Generate Reports</p>
